export default function Terms(){
    return (
        <div className="bg-white rounded-lg shadow px-5 py-6 sm:px-6">
            <h1 className="text-xl font-bold text-center p-2">Terms and Conditions</h1>
              <p className="p-3">
...
<p className="p-2">It should be noted that IIC TMSL will not take responsibility for certain things. Parts of the website will need an active internet connection which can be Wi-Fi or any mobile network provider, but IIC TMSL will not take responsibility if the site does not work properly if you do not have the access to any active internet connection or Wi-Fi.</p>
              <p className="p-2">In case you’re using our site outside of any area with Wi-Fi, you should keep in mind that the terms and conditions still apply to your mobile network provider. Therefore, you can be charged by your mobile network provider for the data for the duration of the internet connection while using the website or any third-party charges. By using the website, you accept the responsibilities for charges like roaming data charges (if you’re accessing the site outside of your location network area) without disabling data roaming. We assume that you have permission from the bill payer for accessing the site, in case you’re not the bill payer for the device you’re using the site from. </p>
              <p className="p-2">If your device runs out of battery and you cannot avail of our services, IIC TMSL cannot take responsibility for it. </p>
              <p className="p-2">You should be aware of the fact that we rely on third parties to provide us with information so that we can make them accessible to you. IIC TMSL should not be held responsible for any loss, whether direct or indirect, you experience while depending entirely on the functionality of the site.</p>
             
              <h1 className="text-xl font-bold p-2">Changes to the Terms and Conditions</h1>
